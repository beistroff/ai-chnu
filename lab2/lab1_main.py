...
class ImageProcessor:
    def __init__(self, root, vectors_s1_class1_max, vectors_s1_class1_min,
        ...
        self.feature_vector_text.grid(column=0, row=8, padx=10)

        self.class_vector_label = tk.Label(self.right_frame, text="Class Vector:", bg="#FFFFFF")
        self.class_vector_label.grid(column=0, row=9)

        self.class_vector_text = tk.Text(self.right_frame, height=3, width=40, bg="#F9F9F9", bd=1)
        self.class_vector_text.grid(column=0, row=10, padx=10)
        ...
        self.normalized_vector_text_s1.grid(column=0, row=12, padx=10)

        self.normalized_vector_label = tk.Label(self.right_frame, text="Normalized Vector For Module:", bg="#FFFFFF")
        ...
        self.normalized_vector_text_s2.grid(column=0, row=14, padx=10)

        self.vector_label_s = tk.Label(self.right_frame, text="Classes vectors S:", bg="#FFFFFF")
        self.vector_label_s.grid(column=0, row=15)

        self.vector_text_s = tk.Text(self.right_frame, height=6, width=55, bg="#F9F9F9", bd=1)
        self.vector_text_s.grid(column=0, row=16, padx=10)

        self.vector_label_m = tk.Label(self.right_frame, text="Classes vectors M:", bg="#FFFFFF")
        self.vector_label_m.grid(column=0, row=17)

        self.vector_text_m = tk.Text(self.right_frame, height=6, width=55, bg="#F9F9F9", bd=1)
        self.vector_text_m.grid(column=0, row=18, padx=10)
